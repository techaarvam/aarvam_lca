...
echo ""
echo "Recommended: use qwen3-8b-32k instead (better quality, same proxy):"
echo "  ollama pull qwen3:8b"
echo "  printf 'FROM qwen3:8b\nPARAMETER num_ctx 32768\n' | ollama create qwen3-8b-32k -f /dev/stdin"
echo "  ~/.opencode/bin/opencode run --model ollama-proxy/qwen3-8b-32k --dangerously-skip-permissions 'your task'"
